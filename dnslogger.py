...
#flush buat clear internal buffer of a file
...
def get_log_handle(sec):
    ...
    _ = os.path.join(LOG_DIRECTORY, "%d-%02d-%02d.log.gz" % (localtime.tm_year, localtime.tm_mon, localtime.tm_mday)) #bikin path
